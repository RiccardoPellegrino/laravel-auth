                ...
                <form action="{{route('admin.projects.store')}}" method="POST" enctype="multipart/form-data" class="p-4">
                    @csrf
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('link_git') is-invalid @enderror" id="link_git" name="link_git">
                        @error('link_git')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('lvl_diff') is-invalid @enderror" id="lvl_diff" name="lvl_diff">
                        @error('lvl_diff')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
