    ...
    <table class="table table-striped">
        ...
        @foreach($projects as $project)
                <tr>
                    ...
                    <td><a href="{{route('admin.projects.show', $project->slug)}}" title="View Post">{{$project->name_project}}</a></td>
                    ...
                    <td>
                        ...
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="delete-button btn btn-danger ms-3" data-item-title="{{$project->name_project}}"><i class="fa-solid fa-trash-can"></i></button>
                     </form>
                    </td>
                </tr>
        @endforeach
